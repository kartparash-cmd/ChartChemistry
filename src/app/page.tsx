...
const SOCIAL_PROOF = [
  ...
  },
  {
    ...
    description: "Natal and synastry charts generated by our community",
  },
];
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              <Calendar aria-hidden="true" className="h-4 w-4 text-cosmic-purple-light" />
            ...
            <div className="flex items-center gap-2">
              <Sparkles aria-hidden="true" className="h-4 w-4 text-cosmic-purple-light" />
              ...
              >
                <TiltCard className="glass-card group rounded-2xl p-6 transition-all hover:border-cosmic-purple/30 h-full">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-cosmic-purple/10 text-cosmic-purple-light transition-colors group-hover:bg-cosmic-purple/20">
                    <dim.icon aria-hidden="true" className="h-6 w-6" />
                  </div>
      ...
      <section className="relative px-4 py-20">
        ...
        >
          <h2 className="text-3xl font-bold sm:text-4xl">
            ...
            <span className="cosmic-text">cosmic connection?</span>
          </h2>
          <p className="mt-4 text-muted-foreground">
            Enter two birth charts and get a real compatibility breakdown in
            seconds &mdash; no signup required.
          </p>
          <Button
            asChild
            size="lg"
            className="mt-8 h-14 rounded-full bg-gradient-to-r from-cosmic-purple to-gold px-8 text-base font-semibold text-white shadow-lg transition-all hover:shadow-cosmic-purple/40 hover:shadow-xl hover:brightness-110 focus-visible:ring-2 focus-visible:ring-cosmic-purple-light focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            <Link
              href="/compatibility"
              onClick={() =>
                trackEvent("cta_click", { location: "mid-page" })
              }
            >
              Check Your Compatibility &mdash; Free
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-cosmic-purple/20">
                    <Sparkles aria-hidden="true" className="h-6 w-6 text-cosmic-purple-light" />
                  </div>
                  <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2 text-sm">
                    <Check aria-hidden="true" className="mt-0.5 h-4 w-4 shrink-0 text-cosmic-purple-light" />
      ...
      <section className="relative px-4 py-24">
        <div className="mx-auto max-w-6xl">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-3xl font-bold sm:text-4xl">What Astrology Lovers Say</h2>
            <p className="mt-3 text-muted-foreground">
              Voices from our cosmic community.
            </p>
          </motion.div>
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground/50">
            Testimonials reflect typical user sentiments.
          </p>
        </div>
      </section>
